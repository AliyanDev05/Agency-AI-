...
function Navbar({ theme, setTheme }) {
  ...
  return (
    <div
      ...
      lg:px-24 xl:px-40 py-4 font-medium sticky top-0 z-20 backdrop-blur-xl 
    ...
    >
      ...
      top-0 bottom-0 right-0 max-sm:min-h-screen 
      max-sm:h-full max-sm:pt-20 max-sm:flex-col max-sm:bg-primary
      max-sm:text-white flex sm:items-center gap-5 transition-all`}
      >
        <img
          src={assets.close_icon}
          alt=""
          className="w-5 absolute top-4 right-12 sm:hidden"
