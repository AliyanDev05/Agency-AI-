...
const ServiceCard = ({ services, index }) => {
  ...
  const handleMouseMove = (e) => {
    const handle = divRef.current.getBoundingClientRect();
    setPosition({ x: e.clientX - handle.left, y: e.clientY - handle.top });
  };
  ...
  return (
    ...
    >
      ...
      from-blue-500 via-indigo-500 to-purple-500 w-[300px] h-[300px] absolute z-0 transition-opacity 
